	...
	const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
		...
		try {
			...
			if (resp.status === 200) {
				...
				localStorage.setItem('bingeToken', user.token.token);
		...
		<>
			<Head>
				...
				<meta
					name={'description'}
					content={
						'Login to Binge Lists to manage your Movies, Tv, Favourites, and share what to Binge next!'
					}
				/>
			</Head>
			<div className={styles.login_container}>
				...
				<div className={styles.form_container}>
					<h1>
						<span className={styles.span_blue}>B</span>inge{' '}
						<span className={styles.span_yellow}>L</span>ogin
					</h1>
